  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (userType === "customer") {
      ...
      try {
        ...
        toast.success(
          response.message || "Seller account created! Awaiting approval.",
        );
        navigate("/");
      } catch (error: any) {
        const message =
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center gap-2">
              <span className="text-xl sm:text-2xl font-display text-gold">
                Druk
              </span>
              <span className="text-xl sm:text-2xl font-display text-warm-white">
                E Com
              </span>
            </Link>
            <Link
              to="/"
              className="flex items-center gap-2 text-warm-gray hover:text-gold transition-colors font-body text-sm"
            >
          ...
          <div className="hidden lg:flex flex-col justify-center">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-warm-white font-body font-medium">
                    Premium Products
                  </p>
                  <p className="text-warm-gray text-sm font-body">
                    Curated selection from top sellers
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      className="w-4 h-4 rounded border-white/20 bg-dark-base text-gold focus:ring-gold"
                    />
